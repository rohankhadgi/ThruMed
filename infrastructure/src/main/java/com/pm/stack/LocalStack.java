...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4300),
                        authServiceDb,
                        Map.of("JWT_SECRET", "BCVxaPhgv1j9vy5PcsS66dWGJxMLiKzMpp1CZKNDCTXzCHMWBdiScmOBuwdVthl6"));
    ...
    private Cluster createEcsCluster() {
        return Cluster.Builder.create(this, "ThruMedCluster")
                .vpc(vpc)
        ...
        ContainerDefinitionOptions containerOptions =
                ContainerDefinitionOptions.builder()
                        ...
                        .environment(Map.of(
                                ...
                                "AUTH_SERVICE_URL", "http://host.docker.internal:4300"
                        ))
                        .portMappings(List.of(4200).stream()
                                .map(port -> PortMapping.builder()
                                        .containerPort(port)
                                        .hostPort(port)
                                        .protocol(Protocol.TCP)
