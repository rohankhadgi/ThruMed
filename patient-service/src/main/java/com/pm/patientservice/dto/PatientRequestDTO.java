...
public class PatientRequestDTO {
    ...
    @Size(min = 8, max = 8, message = "Driver License should be valid")
    ...
    public @Size(min = 8, max = 8, message = "Driver License should be valid") String getDriverLicense() {
        return driverLicense;
    }

    public void setDriverLicense(@Size(min = 8, max = 8, message = "Driver License should be valid") String driverLicense) {
