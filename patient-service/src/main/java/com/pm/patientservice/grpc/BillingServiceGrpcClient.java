...
public class BillingServiceGrpcClient {
    ...
    public BillingResponse createBillingAccount(String patientId, String name, String email, String driverLicense) {
        BillingRequest request =
                BillingRequest.newBuilder().setPatientId(patientId).setName(name).setEmail(email).setDriverLicense(driverLicense).build();
